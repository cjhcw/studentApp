...
public class main_page extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ima_liaotian.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(main_page.this, Chat_page.class);
				startActivity(intent);
			}
		});
		ima_toujian.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(main_page.this, Send_page.class);
				startActivity(intent);
			}
		});
		ima_wode.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(main_page.this, Wode_page.class);
				startActivity(intent);
			}
		});
	}
