	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ima_shouye.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(Chat_page.this, main_page.class);
		...
		ima_liaotian.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(Chat_page.this, Chat_page.class);
				startActivity(intent);
			}
		});
		ima_toujian.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(Chat_page.this, Send_page.class);
				startActivity(intent);
			}
		});
		ima_wode.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(Chat_page.this, Wode_page.class);
				startActivity(intent);
			}
		});
	}
